  ...
  float Temperature::analog_to_celsius_hotend(const int raw, const uint8_t e) {
    ...
    switch (e) {
      ...
      case 1:
        ...
        #elif ENABLED(HEATER_1_USES_ADS1118)
          return raw/10.0f;
...
void Temperature::updateTemperaturesFromRawValues() {
  /* FLASHFORGE */
    ...
    temp_hotend[0].raw = ads1118_read_raw( 0 );
  #endif
  #if ENABLED(HEATER_1_USES_ADS1118)
    temp_hotend[1].raw = ads1118_read_raw( 1 );
  #endif
...
void Temperature::update_raw_temperatures() {
    ...
    #elif DISABLED(HEATER_1_USES_MAX6675) && DISABLED(HEATER_1_USES_ADS1118)
