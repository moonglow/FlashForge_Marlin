...
void Temperature::updateTemperaturesFromRawValues() {
  ...
  TERN_(TEMP_SENSOR_0_IS_ADS1118, temp_hotend[0].raw = ads1118_read_raw(0));
  TERN_(TEMP_SENSOR_1_IS_ADS1118, TERN(TEMP_SENSOR_1_AS_REDUNDANT, temp_redundant, temp_hotend[1]).raw = ads1118_read_raw(1));
  #if HAS_HOTEND
