...
#define ANY_TEMP_SENSOR_IS(n) (TEMP_SENSOR_0 == (n) || TEMP_SENSOR_1 == (n) || TEMP_SENSOR_2 == (n) || TEMP_SENSOR_3 == (n) || TEMP_SENSOR_4 == (n) || TEMP_SENSOR_5 == (n) || TEMP_SENSOR_6 == (n) || TEMP_SENSOR_7 == (n) || TEMP_SENSOR_BED == (n) || TEMP_SENSOR_PROBE == (n) || TEMP_SENSOR_CHAMBER == (n))
  ...
  #define HEATER_0_ADS1118_TMIN 0
  #define HEATER_0_ADS1118_TMAX 1024
#else
  ...
  #define HEATER_1_ADS1118_TMIN 0
  #define HEATER_1_ADS1118_TMAX 1024
#else
...
#if HAS_HOTEND && ( EITHER(HAS_TEMP_ADC_0, HEATER_0_USES_MAX6675) || ENABLED( HEATER_0_USES_ADS1118 ) )
