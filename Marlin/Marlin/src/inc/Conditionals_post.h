...
#endif
#if HAS_Z_AXIS
  /* workaround for new marlin macro hell */
...
//
#define HAS_ADC_TEST(P) (PIN_EXISTS(TEMP_##P) && TEMP_SENSOR_##P != 0 && NONE(TEMP_SENSOR_##P##_IS_MAX_TC, TEMP_SENSOR_##P##_IS_ADS1118, TEMP_SENSOR_##P##_IS_DUMMY))
...
#define HAS_TEMP(N) ANY(HAS_TEMP_ADC_##N, TEMP_SENSOR_##N##_IS_MAX_TC, TEMP_SENSOR_##N##_IS_ADS1118, TEMP_SENSOR_##N##_IS_DUMMY)
...
// Thermal protection
  ...
  && (1/*ENABLED(THERMAL_PROTECTION_CHAMBER) || !HAS_HEATED_CHAMBER*/) \
