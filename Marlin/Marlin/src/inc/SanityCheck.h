 ...
 */
...
#elif TEMP_SENSOR_0_IS_ADS1118 && !ANY_PIN(ADS1118_CS)
  #error "TEMP_SENSOR_0 requires a ADS1118_CS_PIN."
  ...
  #elif TEMP_SENSOR_1_IS_ADS1118 && !ANY_PIN(ADS1118_CS)
    #error "TEMP_SENSOR_1 requires a ADS1118_CS_PIN."
